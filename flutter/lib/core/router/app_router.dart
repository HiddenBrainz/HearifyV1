      ...
      GoRoute(
        ...
        builder: (ctx, state) {
          ...
          return ModuleProgramScreen(
            program: program,
            onStartTraining: () {
              ctx.go(id == 2 ? '/speaking' : '/listening');
            },
          );
        },
      ),
        ...
        child: ListView(
          ...
          children: [
            ...
            _moduleTile(
              ...
              icon: Icons.hearing,
              onTap: () => context.go('/education/module/1'),
              b: b,
            ),
            ...
            _moduleTile(
              ...
              onTap: () => context.go('/listening/voice-test'),
              b: b,
            ),
            const SizedBox(height: 12),
            _moduleTile(
              ...
              icon: Icons.mic,
              onTap: () => context.go('/education/module/2'),
              b: b,
            ),
            const SizedBox(height: 12),
            _moduleTile(
            ...
            _moduleTile(
              ...
              icon: Icons.share,
              onTap: () => context.go('/clinician/link'),
              b: b,
            ),
            const SizedBox(height: 12),
            _moduleTile(
              ...
              onTap: () => context.go('/clinician/dashboard'),
              b: b,
            ),
            const SizedBox(height: 12),
            _moduleTile(
